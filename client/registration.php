...
if (isset($_REQUEST['username'])){
    ...
    $query = "INSERT INTO `users`(username, f_name, l_name, acc_type, email_add, pass, birthdate, phone_number) VALUES ('$username','$firstname','$lastname','customer','$email', '".md5($password)."','$birthdate','$phone')";
