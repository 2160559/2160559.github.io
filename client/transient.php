        ...
        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
          ...
          <div class="btn-grp" role="group" aria-label="Second group">
            <div class="btn-group-toggle" data-toggle="buttons">
              <input class="btn btn-outline-info active btn-lg btn-block" type="submit" name="submit" value="Save to List">
            </div>
          </div>
          ...
          <div class="btn-grp" role="group" aria-label="Fourth group">
            <a class="btn-dark btn btn-lg btn-block" href="gallery.php" name="submit">View Photos</a>
          </div>
        </div>
      </div>
